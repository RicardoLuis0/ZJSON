...
class placeholder_JSON
{
	...
	{ // returns one of:
	  //	placeholder_JsonArray
	  //	placeholder_JsonObject
	  //	placeholder_JsonString
	  //	placeholder_JsonInt
	  //	placeholder_JsonDouble
	  //	placeholder_JsonNull
	  //	placeholder_JsonError
		skipWhitespace(data, i, len, line);
		if(i >= len)
		{
		...
		else if(c == "+" || c == "-")
		{
			...
			if(c == "-" && num is "placeholder_JsonNumber")
			{
